# spring-cloud-test
基于 SpringBoot 2.x 。主要参考了 https://github.com/ityouknow/spring-cloud-examples ，一些具体信息见上面这里
### eureka server（s1, s2）  
...
### git server single
需要在client中配置bootstrap.yml和相应的git server，同时开放相应url才可以访问，  
貌似配置中的端口 refresh无法更改，需要真实重启   
